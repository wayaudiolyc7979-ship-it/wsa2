...
from PyQt5.QtWidgets import (QDialog, QDialogButtonBox, QDoubleSpinBox, QFrame, QHBoxLayout,
    ...
    QAbstractItemView, QApplication, QComboBox, QGridLayout, QGroupBox, QLineEdit, QScrollArea)
...
from spectra.ui.tokens import ss_btn_neutral, ss_btn_primary, ss_dialog_btns, ss_spin, FS_LG, FONT_FAMILY
